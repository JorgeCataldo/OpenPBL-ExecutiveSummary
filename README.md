...
Grande parte deste desequilibrio ocorre porque as escolas que tradicionalmente desenvolvem habilidades comportamentais de seus alunos operam modelos de negócios que não possuem **economias de escala** suficientes para popularizar seus produtos. É o caso das escolas que ofertam programas apoiados por *Problem Based Learning (PBL)*, uma **estratégia de aprendizagem** comprovadamente **eficaz** no desenvolvimento de habilidades comportamentais e, portanto, candidata natural para reduzir este desequilibrio do mercado.
